...
public class Checkout {
    ...
    public boolean isOrderSummaryAccurate() {
        ...
        By itemTotalLocator = By.className("summary_subtotal_label");
        By taxLocator = By.className("summary_tax_label");
        By totalLocator = By.className("summary_total_label");
        By inventoryItemsLocator = By.className("inventory_item_price");
