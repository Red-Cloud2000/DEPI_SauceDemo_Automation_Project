...
//    }
    ...
    public void testInvalidCheckoutInfo() {
        ...
        WebElement errorMessage = driver.findElement(checkout.errorMessage).isDisplayed();
        BaseTest.validateTestResult(errorMessage.contains("Error"), "TestCase ID:DPSAT-T46 - Verify Checkout with Invalid Input");
        Assert.assertTrue(errorMessage.contains("Error"), "Error message should be displayed for invalid input");
    }
