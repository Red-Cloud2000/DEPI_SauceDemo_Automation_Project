...
public class CheckoutTest extends BaseTest {
    ...
    @Test(priority = 2)
    public void testCheckoutWithoutShipping() {
...
//    @Test(priority = 3)
//    public void testCheckoutWithMultipleItems() throws InterruptedException {
//        Thread.sleep(3000);
//
...
//        checkout.clickFinish();
//        String confirmationMessage = checkout.getOrderConfirmationMessage();
//        BaseTest.validateTestResult(confirmationMessage.contains("Thank you for your order!"), "TestCase ID:DPSAT-T25 - Verify checkout with multiple items");
//        Assert.assertTrue(confirmationMessage.contains("Thank you for your order!"), "Order should be placed successfully with multiple items");
//    }
    ...
    public void testValidFirstName() {
        ...
        checkout.clickContinue();
        BaseTest.validateTestResult(!checkout.getErrorMessage().contains("First Name"), "TestCase ID:DPSAT-T46 - Verify First Name within Valid input");
        Assert.assertFalse(checkout.getErrorMessage().contains("First Name"), "First name should be accepted as valid input");
    }
    ...
    public void testValidLastName() {
        ...
        checkout.clickContinue();
        BaseTest.validateTestResult(!checkout.getErrorMessage().contains("Last Name"), "TestCase ID:DPSAT-T47 - Verify Last Name filed within Valid Input");
        Assert.assertFalse(checkout.getErrorMessage().contains("Last Name"), "Last name should be accepted as valid input");
    }
    ...
    public void testValidPostalCode() {
        ...
        checkout.clickContinue();
        BaseTest.validateTestResult(!checkout.getErrorMessage().contains("Postal Code"), "TestCase ID:DPSAT-T48 - Verify Postal Code with Valid Input");
        Assert.assertFalse(checkout.getErrorMessage().contains("Postal Code"), "Postal code should be accepted as valid input");
    }
